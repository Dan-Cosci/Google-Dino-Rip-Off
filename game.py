...
class Game():
    def __init__(self,scrwid, scrhei):
        ...
        self.score_txt = py.font.Font('assets/dogica.ttf', 25)
        ...
        py.time.set_timer(self.obstacle_timer, 500)
    ...
    def text(self,screen):
        text = self.score_txt.render(str(self.score),False,'Black')
        text_rect = text.get_rect(center= (config.SCRWID / 2, config.SCRHEI / 2  - 175))
